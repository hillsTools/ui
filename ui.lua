...
local function InitSlider(Parent,ScreenAsset,Window,Slider)
	...
	SliderAsset.InputBegan:Connect(handleSliderInput)
...
local function InitColorpicker(Parent,ScreenAsset,Window,Colorpicker)
	...
	ColorpickerAsset.InputBegan:Connect(function(Input)
		if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and not PaletteAsset.Visible then
	...
	PaletteAsset.Rainbow.InputBegan:Connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
